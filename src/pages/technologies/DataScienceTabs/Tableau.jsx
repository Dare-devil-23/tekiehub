    ...
    <div>
      ...
      <div className='md:px-5'>
        <ul className='md:px-10 list-disc pl-5 text-gray-500'>
          ...
          <br />
          <li>
            The desktop feature helps create customized reports and dashboards to get
            real-time insights and updates.
          </li>
          <br />
          <li>
            The cross-database join functionality allows to make calculated fields and join
            tables for solving complex data problems.
          </li>
        </ul>
      </div>
    </div>
