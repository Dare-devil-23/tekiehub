...
const Benifits = (
    <div>
        ...
        <br />
        <ul className='md:mx-16 list-disc pl-5'>
            <li>
                <span className='font-bold mr-2'>Independence:</span>
            ...
            <br />
            <li>
                <span className='font-bold mr-2'>No downtime:</span>
