...
const UIPath = (
  <div className='w-4/5 mx-auto py-10 text-lg'>
    ...
    <div className='md:px-5'>
      ...
      into automation process using multiple tools. It was founded by Romanian
      entrepreneur Daniel Dines in the year 2005.
      More and more companies are adopting Digital day by day. With digitization,
      the biggest advantage is the speed of execution. But the challenge with
      ...
      <div className='md:px-5'>
        <ul className='md:px-5 list-disc pl-5'>
          ...
          <li>
            ...
            <ul className='list-decimal md:px-10 py-5'>
              <li>
                Effective debugging and exception handling mechanisms
              </li>
              <li>
                Artificial intelligence handling day to day applications like
                outlooks excel, PDF.
              </li>
            </ul>
          </li>
      ...
      <div className='md:px-5'>
        <p>
          ...
          automation but fail miserably when you try to automate desktop
