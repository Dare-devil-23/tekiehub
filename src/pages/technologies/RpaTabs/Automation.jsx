    ...
    <div className='md:px-5'>
      ...
      <div className='md:px-5'>
        <ul className='md:px-5 list-disc pl-5'>
          <li>
            <span className='font-bold mr-2'>Control Room:</span>
          ...
          <br />
          <li>
            <span className='font-bold mr-2'> Bot Creator:</span>
          ...
          <br />
          <li>
            <span className='font-bold mr-2'> Bot Runner: </span>
          ...
          <br />
          <li>
            <span className='font-bold mr-2'> BOT Insights: </span>
          ...
          <br />
          <li>
            <span className='font-bold mr-2'> Bot Farm: </span>
          ...
          <br />
          <li>
            <span className='font-bold mr-2'> Bot Store: </span>
      ...
      <div className='md:px-5'>
        <ul className='md:px-5 list-disc pl-5'>
          <li>
            <span className='font-bold mr-2'>Task Bots:</span>
          ...
          <br />
          <li>
            <span className='font-bold mr-2'> Meta Bots:</span>
          ...
          <br />
          <li>
            <span className='font-bold mr-2'> IQ BOT: </span>
